...
# Unit tests for OpenapiClient::Quotes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Quotes do
  let(:instance) { OpenapiClient::Quotes.new }

  describe 'test an instance of Quotes' do
    it 'should create an instance of Quotes' do
      expect(instance).to be_instance_of(OpenapiClient::Quotes)
    end
  end
