...
# Unit tests for OpenapiClient::Movies
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Movies do
  let(:instance) { OpenapiClient::Movies.new }

  describe 'test an instance of Movies' do
    it 'should create an instance of Movies' do
      expect(instance).to be_instance_of(OpenapiClient::Movies)
    end
  end
